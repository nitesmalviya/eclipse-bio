    ...
    const projectsList = [
        {
            id: 1,
            name: "Serum",
            sample_type: "Serum and plasma samples",
            assay: "ELISA Assay",
            enum: "OWNED",
                    ...
                    <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-[48px]">
                        {
                            projectsList.map((projectItem) => (
                                <div
                                    key={projectItem.id}
                                    className="relative w-full h-[417px] rounded-[18px] p-[2px] bg-gradient-to-r from-[#f2f5f5] via-[#e7f8f8] to-[#f2f5f5] bg-[length:200%_200%] animate-borderMove">
                                    <div className="relative flex flex-col w-full h-full rounded-[16px] overflow-hidden hover:shadow-xl transition-shadow">
                                        ...
                                        <div className="h-[226px] p-[24px] flex flex-col">
                                            <h3 className="mb-4" >{projectItem.name}</h3>
                                            <div className="flex flex-col gap-3 mt-auto">
                                                <div className="flex items-start gap-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="text-sm text-[#525F69]">{
                                                            projectItem.sample_type}</span>
                                                    </div>
                                                </div>
                                                <div className="flex items-start gap-2">
                                        ...
                                        <div className="h-[53px] px-[24px] pb-[24px] flex items-center justify-start mt-auto relative z-10">
                                            <div className={`
                                                w-[77px] h-[26px] flex items-center justify-center rounded-[100px] 
                                                ${projectItem.enum === "Buy" ? "bg-[#009CA6]" : "bg-[#e9c110]"}
                                            `}>
